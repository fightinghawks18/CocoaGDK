...
inline Vec3 ccoCreateVec3(const f32 x, const f32 y, const f32 z) {
    Vec3 vec3;
    vec3.x = x;
    vec3.y = y;
    vec3.z = z;
...
inline Vec3 ccoCreateVec3Up() {
    return ccoCreateVec3(0, 1, 0);
}

inline Vec3 ccoCreateVec3Right() {
    return ccoCreateVec3(1, 0, 0);
}

inline Vec3 ccoCreateVec3Forward() {
    return ccoCreateVec3(0, 0, 1);
}
...
inline Vec3 ccoNormalizeVec3(const Vec3 vec3) {
    ...
    return ccoCreateVec3(vec3.x/mag, vec3.y/mag, vec3.z/mag);
}
