...
CCO_OPENGL_API void cco_opengl_flush_context_buffer(cco_opengl_context opengl_context);
CCO_OPENGL_API void cco_opengl_make_current_context(cco_opengl_context opengl_context);