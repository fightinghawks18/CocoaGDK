...
CCO_OPENGL_API void cco_use_opengl_ebo(cco_opengl_ebo ebo);
CCO_OPENGL_API void cco_map_to_opengl_ebo(cco_opengl_ebo ebo, const cco_buffer_mapping *mapping);

CCO_OPENGL_API u32 cco_get_opengl_ebo_id(cco_opengl_ebo ebo);